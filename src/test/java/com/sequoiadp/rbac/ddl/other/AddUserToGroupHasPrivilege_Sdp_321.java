...
/*
 * @Description   : add user to groups which has privilege assigned
 * @Author        : Lena
 */

public class AddUserToGroupHasPrivilege_Sdp_321 extends SDPTestBase {
	public AddUserToGroupHasPrivilege_Sdp_321() {
