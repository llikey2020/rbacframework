...
/*
 * @Description   : add group to group which has privilege assigned
 * @Author        : Lena
 */
public class AddGroupToGroupHasPrivilege_Sdp_323 extends SDPTestBase {
	public AddGroupToGroupHasPrivilege_Sdp_323() {
