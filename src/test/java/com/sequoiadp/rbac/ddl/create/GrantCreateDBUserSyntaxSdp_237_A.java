...
/*
 * @Description   : GRANT CREATE ON DATABASE TO USER syntax validation
 * @Author        : Lena
 */
public class GrantCreateDBUserSyntaxSdp_237_A extends SDPTestBase {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("creat","database",DBNAME,"user",getConfig("testUser"));
