...
/*
 * @Description   : GRANT CREATE ON DATABASE TO GROUP syntax validation
 * @Author        : Lena
 */
public class GrantCreateDBGroupSyntaxSdp_237_B extends SDPTestBase {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("creat","database",DBNAME,"group",getConfig("testGroup"));
