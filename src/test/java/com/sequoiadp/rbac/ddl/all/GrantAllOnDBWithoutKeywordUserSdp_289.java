...
/*
 * @Description   : GRANT ALL ON DATABASE without USER keyword
 * @Author        : Lena
 */

public class GrantAllOnDBWithoutKeywordUserSdp_289 extends SDPTestBase {

    public static final String TABLENAME = "newtablename";
    public GrantAllOnDBWithoutKeywordUserSdp_289() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("all","database",getConfig("dbName"),"",getConfig("testUser"));
