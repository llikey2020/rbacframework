...
/*
 * @Description   : GRANT ALL ON DATABASE without granting usage to user
 * @Author        : Lena
 */

public class GrantAllDBWithoutUsageSdp_294 extends SDPTestBase {

    public static final String TABLENAME = "newtablename";
    public GrantAllDBWithoutUsageSdp_294() {
