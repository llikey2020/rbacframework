...
public class GrantAllOnTableGroupSyntaxSdp_273_B extends SDPTestBase {
    public GrantAllOnTableGroupSyntaxSdp_273_B() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("al","table",tableName,"group",getConfig("testGroup"));
