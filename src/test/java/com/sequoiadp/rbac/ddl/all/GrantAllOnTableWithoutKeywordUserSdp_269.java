...
/*
 * @Description   : GRANT ALL ON TABLE without USER keyword
 * @Author        : Lena
 */

public class GrantAllOnTableWithoutKeywordUserSdp_269 extends SDPTestBase {
    public GrantAllOnTableWithoutKeywordUserSdp_269() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("all","table",tableName,"",getConfig("testUser"));
