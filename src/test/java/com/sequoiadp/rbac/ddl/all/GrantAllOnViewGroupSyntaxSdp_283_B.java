...
/*
 * @Description   : GRANT ALL ON VIEW TO GROUP syntax validation
 * @Author        : Lena
 */

public class GrantAllOnViewGroupSyntaxSdp_283_B extends SDPViewTestBase {
    public GrantAllOnViewGroupSyntaxSdp_283_B() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsqlview = HiveConnection.getInstance().grantSql("al","view",viewName,"group",getConfig("testGroup"));
