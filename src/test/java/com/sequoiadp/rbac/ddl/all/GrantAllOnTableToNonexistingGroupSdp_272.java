...
/*
 * @Description   : GRANT ALL ON TABLE TO GROUP <non existing groupname>
 * @Author        : Lena
 */

public class GrantAllOnTableToNonexistingGroupSdp_272 extends SDPTestBase {
    public GrantAllOnTableToNonexistingGroupSdp_272() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("all","table",tableName,"group","nonexistinggroup");
