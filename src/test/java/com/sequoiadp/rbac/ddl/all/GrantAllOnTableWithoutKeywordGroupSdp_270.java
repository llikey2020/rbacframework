...
/*
 * @Description   : GRANT ALL ON TABLE without GROUP keyword
 * @Author        : Lena
 */

public class GrantAllOnTableWithoutKeywordGroupSdp_270 extends SDPTestBase {
    public GrantAllOnTableWithoutKeywordGroupSdp_270() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("all","table",tableName,"",getConfig("testGroup"));
