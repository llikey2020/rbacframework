...
/*
 * @Description   : GRANT ALL ON DATABASE TO GROUP syntax validation 
 * @Author        : Lena
 */

public class GrantAllDBGroupSyntaxSdp293_B extends SDPTestBase {

    public static final String TABLENAME = "newtablename";
    public GrantAllDBGroupSyntaxSdp293_B() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("al","database",getConfig("dbName"),"group",getConfig("testGroup"));
