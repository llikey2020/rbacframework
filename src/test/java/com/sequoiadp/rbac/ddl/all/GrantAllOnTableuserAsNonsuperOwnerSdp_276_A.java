...
/*
 * @Description   : Non super user/non owner GRANT ALL ON TABLE to user
 * @Author        : Lena
 */

public class GrantAllOnTableuserAsNonsuperOwnerSdp_276_A extends SDPTestBase {
    public GrantAllOnTableuserAsNonsuperOwnerSdp_276_A() {
