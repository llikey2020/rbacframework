...
/*
 * @Description   : GRANT ALL ON DATABASE without granting usage to group
 * @Author        : Lena
 */

public class GrantAllDBWithoutUsageSdp_295 extends SDPTestBase {

    public static final String TABLENAME = "newtablename";
    public GrantAllDBWithoutUsageSdp_295() {
    ...
    //测试点
    @Test
    //(expectedExceptions =  { java.sql.SQLException.class },expectedExceptionsMessageRegExp = ".*does not have USAGE privilege on.*")
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("all","database",getConfig("dbName"),"group",getConfig("testGroup"));
