...
/*
 * @Description   : GRANT ALL ON VIEW without USER keyword
 * @Author        : Lena
 */

public class GrantAllOnViewWithoutKeywordUserSdp_279 extends SDPViewTestBase {
    public GrantAllOnViewWithoutKeywordUserSdp_279() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsqlview = HiveConnection.getInstance().grantSql("all","view",viewName,"",getConfig("testUser"));
