...
/*
 * @Description   : GRANT READ_METADATA ON DATABASE to group privilege syntax validation
 * @Author        : Lena
 */

public class GrantRead_metadataOnDBToGroupSyntaxSdp_310_B extends SDPTestBase {
    public GrantRead_metadataOnDBToGroupSyntaxSdp_310_B() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("read_metadat","table",tableName,"group",getConfig("testGroup"));
