...
/*
 * @Description   : GRANT READ_METADATA ON TABLE to GROUP
 * @Author        : Lena
 */

public class GrantRead_metadataOnTableGroupSdp_303 extends SDPTestBase {
    public GrantRead_metadataOnTableGroupSdp_303() {
