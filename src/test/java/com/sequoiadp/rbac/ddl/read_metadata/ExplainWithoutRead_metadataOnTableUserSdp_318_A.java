...
/*
 * @Description   : EXPLAIN statement without read_metadata privilege ON table (user)
 * @Author        : Lena
 */

public class ExplainWithoutRead_metadataOnTableUserSdp_318_A extends SDPTestBase {
    public ExplainWithoutRead_metadataOnTableUserSdp_318_A() {
