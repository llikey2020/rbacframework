...
/*
 * @Description   : GRANT READ_METADATA ON TABLE to USER without USAGE privilege
 * @Author        : Lena
 */

public class GrantRead_metadataOnTableWithoutUsageUserSdp_307_A extends SDPTestBase {
    public GrantRead_metadataOnTableWithoutUsageUserSdp_307_A() {
