...
/*
 * @Description   : GRANT READ_METADATA ON DATABASE to GROUP
 * @Author        : Lena
 */

public class GrantRead_MetadataOnDBToGroupSdp_309 extends SDPTestBase {
    public GrantRead_MetadataOnDBToGroupSdp_309() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsql = HiveConnection.getInstance().grantSql("read_metadata","database",getConfig("dbName"),"group",getConfig("testGroup"));
