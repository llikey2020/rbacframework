...
/*
 * @Description   : GRANT READ_METADATA ON DATABASE to user privilege syntax validation
 * @Author        : Lena
 */

public class GrantRead_metadataOnDBToUserSyntaxSdp_310_A extends SDPTestBase {
    public GrantRead_metadataOnDBToUserSyntaxSdp_310_A() {
