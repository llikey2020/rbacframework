...
public class OwnerShipTransferGroupSdp_358 extends SDPTestBase {
    public OwnerShipTransferGroupSdp_358() {
    ...
    public void test() throws SQLException, InterruptedException {
        ...
        try {
            ...
            String transferowner = "ALTER table " + "testtable" + " OWNER TO group " +  getConfig("testGroup");
