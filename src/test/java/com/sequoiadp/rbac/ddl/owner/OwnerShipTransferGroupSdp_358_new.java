...
public class OwnerShipTransferGroupSdp_358_new extends SDPTestBase {
	public static final String TNAME = "newtname22";
    public OwnerShipTransferGroupSdp_358_new() {
    ...
    public void test() throws SQLException, InterruptedException {
        ...
        try {
            ...
            String transferowner = "ALTER table " + TNAME + " OWNER TO group " +  getConfig("testGroup");
