...
public class OwnerShipTransferWithoutOwnerGroupSdp_361A extends SDPTestBase {
    public OwnerShipTransferWithoutOwnerGroupSdp_361A() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String transferowner = "ALTER TABLE " + tableName + " OWNER TO group " +  getConfig("testGroup");
