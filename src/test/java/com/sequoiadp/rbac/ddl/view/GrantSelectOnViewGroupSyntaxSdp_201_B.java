...
/*
 * @Description   : GRANT SELECT ON VIEW TO GROUP syntax validation
 * @Author        : Lena
 */

public class GrantSelectOnViewGroupSyntaxSdp_201_B extends SDPViewTestBase {
    public GrantSelectOnViewGroupSyntaxSdp_201_B() {
    ...
    public void test() throws SQLException {
        ...
        try {
            ...
            String grantsqlview = HiveConnection.getInstance().grantSql("selects","view",viewName,"group",getConfig("testGroup"));
